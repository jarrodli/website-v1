...
(function($PS) {
  ...
  var class_ = function ($0) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($0));
  };
  var col_ = function (content) {
      return Halogen_HTML_Elements.div([ class_("one-third column") ])(content);
  };
  var content_ = Halogen_HTML_Elements.div([ class_("container") ]);
  var github = function (props) {
      return Halogen_HTML_Elements.a(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ class_("github") ])(props));
  };                                                                 
  var h2_ = Halogen_HTML_Elements.h2([ class_("one-third column") ]);
  var h3_ = Halogen_HTML_Elements.h3([ class_("one-third column") ]);

  //--------
  // Svgs
  var linkedin = function (props) {
      return Halogen_HTML_Elements.a(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ class_("linkedin") ])(props));
  };
  var row_ = function (content) {
      return Halogen_HTML_Elements.div([ class_("row") ])(content);
  };
  var src = function (props) {
      return Halogen_HTML_Elements.a(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ class_("src") ])(props));
  };
  exports["h2_"] = h2_;
  exports["h3_"] = h3_;
  exports["p_"] = p_;
...
(function($PS) {
  "use strict";
  $PS["Halogen.Transition"] = $PS["Halogen.Transition"] || {};
  var exports = $PS["Halogen.Transition"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var EnterActive = (function () {
      ...
      EnterActive.value = new EnterActive();
      return EnterActive;
  })();
  var Leave = (function () {
      function Leave() {
  ...
  var LeaveActive = (function () {
      function LeaveActive() {

      };
      LeaveActive.value = new LeaveActive();
      return LeaveActive;
  })();
  var Done = (function () {
      function Done() {
  ...
  var ReceiveProps = (function () {
      function ReceiveProps(value0) {
          this.value0 = value0;
      };
      ReceiveProps.create = function (value0) {
          return new ReceiveProps(value0);
      };
      return ReceiveProps;
  })();
  var Raise = (function () {
  ...
  var HandleTransitionEnd = (function () {
      ...
      HandleTransitionEnd.value = new HandleTransitionEnd();
      return HandleTransitionEnd;
  })();
  var render = function (v) {
      var cls = (function () {
          if (v.transitionState instanceof Enter) {
              return v.props.enterClass;
          };
          if (v.transitionState instanceof EnterActive) {
              return v.props.enterActiveClass;
          };
          if (v.transitionState instanceof Leave) {
              return v.props.leaveClass;
          };
          if (v.transitionState instanceof LeaveActive) {
              return v.props.leaveActiveClass;
          };
          return "";
      })();
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(cls), Halogen_HTML_Events.onTransitionEnd((function () {
          var $49 = Data_Function["const"](HandleTransitionEnd.value);
          return function ($50) {
              return Data_Maybe.Just.create($49($50));
          };
      })()) ])(Control_Bind.join(Control_Bind.bindArray)([ Data_Functor.voidLeft(Data_Functor.functorArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(v.shown))(v.props.render) ]));
  };
  var raise = function (f) {
      return new Raise(f);
  };
  var initialState = function (props) {
      return {
          props: props,
          shown: props.shown,
          transitionState: Done.value
      };
  };
  var handleProps = function (dictMonadAff) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
          if (state.props.shown) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                  ...
                  $21.shown = true;
                  $21.transitionState = Enter.value;
                  return $21;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(1.0)))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                          ...
                          $24.transitionState = EnterActive.value;
                          return $24;
                      });
                  });
              });
          };
          var $27 = state.shown && !state.props.shown;
          if ($27) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                  var $28 = {};
                  for (var $29 in v) {
                  ...
                  $28.transitionState = Leave.value;
                  return $28;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(1.0)))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                          ...
                          $31.transitionState = LeaveActive.value;
                          return $31;
                      });
                  });
              });
  ...
  var eqTransitionState = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Enter && y instanceof Enter) {
              return true;
          };
          if (x instanceof EnterActive && y instanceof EnterActive) {
              return true;
          };
          if (x instanceof Leave && y instanceof Leave) {
              return true;
          };
          if (x instanceof LeaveActive && y instanceof LeaveActive) {
              return true;
          };
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof OnEnter) {
              return handleProps(dictMonadAff);
          };
          if (v instanceof ReceiveProps) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(state.props.shown !== v.value0.shown)(handleProps(dictMonadAff));
                  });
              });
          };
          ...
          if (v instanceof HandleTransitionEnd) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $42 = Data_Eq.eq(eqTransitionState)(s.transitionState)(LeaveActive.value);
                  if ($42) {
                      var $43 = {};
                      for (var $44 in s) {
                  ...
                  $46.transitionState = Done.value;
                  return $46;
              });
          };
          throw new Error("Failed pattern match at Halogen.Transition (line 128, column 16 - line 145, column 42): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              ...
              receive: function ($51) {
                  return Data_Maybe.Just.create(ReceiveProps.create($51));
              },
              initialize: new Data_Maybe.Just(OnEnter.value),
...
(function($PS) {
  ...
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Transition = $PS["Halogen.Transition"];
  var HandleTransition = (function () {
      function HandleTransition(value0) {
          this.value0 = value0;
      };
      HandleTransition.create = function (value0) {
          return new HandleTransition(value0);
      };
  ...
  var _transition = Data_Symbol.SProxy.value;

  //---
  // Render
  var renderAnimation = function (state) {
      return function (t) {
          return function (fade) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "transition";
              }))(Data_Ord.ordUnit)(_transition)(Data_Unit.unit)(Halogen_Transition.component(Effect_Aff_Class.monadAffAff))({
                  enterClass: "simple-enter",
                  enterActiveClass: fade,
                  leaveClass: "simple-leave",
                  leaveActiveClass: "simple-leave-active",
                  shown: state.shown,
                  render: Halogen_HTML_Core.text(t)
              })(function ($0) {
                  return Data_Maybe.Just.create(HandleTransition.create($0));
              });
          };
      };
  };
  var render = function (state) {
      return Halogen_HTML_Elements.section_([ App_Element.row_([ Halogen_HTML_Elements.h1_([ renderAnimation(initialState)("Jarrod Li")("simple-enter-active-2") ]) ]), App_Element.row_([ App_Element.h2_([ renderAnimation(initialState)("Hello \ud83d\udc4b")("simple-enter-active-4") ]) ]), App_Element.content_([ App_Element.row_([ App_Element.h3_([ renderAnimation(initialState)("I'm a software engineer intern at an Australian bank.")("simple-enter-active-8") ]) ]), App_Element.row_([ App_Element.h3_([ renderAnimation(initialState)("I also study Computer Science and Law at UNSW Australia.")("simple-enter-active-8") ]) ]), App_Element.row_([ App_Element.h3_([ renderAnimation(initialState)("This SPA was built with the Halogen framework, and powered by purescript.")("simple-enter-active-8") ]) ]), App_Element.row_([ App_Element.col_([ App_Element.linkedin([ Halogen_HTML_Properties.href("https://www.linkedin.com/in/jarrodli/") ])([ Halogen_HTML_Core.text("") ]) ]), App_Element.col_([ App_Element.github([ Halogen_HTML_Properties.href("https://github.com/jarrodli") ])([ Halogen_HTML_Core.text("") ]) ]), App_Element.col_([ App_Element.src([ Halogen_HTML_Properties.href("https://github.com/jarrodli/jarrodsite ") ])([ Halogen_HTML_Core.text("") ]) ]), App_Element.row_([  ]), App_Element.p_("< admin at jarrodli dot com >") ]) ]) ]);
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (x) {
      return Halogen_VDom_Driver.runUI(App_Home.component)(Data_Unit.unit)(x);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();